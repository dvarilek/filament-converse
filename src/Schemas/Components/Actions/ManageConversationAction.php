...
class ManageConversationAction extends Action
{
    ...
    protected function setUp(): void
    {
        ...
        $this->schema(static function (Schema $schema, ManageConversationAction $action, ConversationManager $livewire, Conversation $conversation): Schema {
            // TODO: Finish LeaveConversationAction, account for the newly added attributes joined_at, present_until in Actions/LeaveConversation and in rendering the available conversations
            // TODO: Add tests for Action schema components
