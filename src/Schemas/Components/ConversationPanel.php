...
class ConversationPanel extends Component
{
    ...
    protected function setUp(): void
    {
        ...
        $this->getConversationImageUrlUsing(static function (ConversationPanel $component, Conversation $conversation) {
        ...
        $this->getDefaultConversationImageDataUsing(static function (ConversationPanel $component, Conversation $conversation) {
