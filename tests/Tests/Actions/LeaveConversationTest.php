...
it('can leave a conversation as a participant', function () {
    ...
    expect($conversation->fresh()->participations)->toHaveCount(1)
        ->and($participant->conversationParticipations()->where('conversation_id', $conversation->getKey())->exists())->toBeFalse()
